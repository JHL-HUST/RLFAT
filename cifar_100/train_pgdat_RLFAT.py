...
s_x_input = tf.placeholder(tf.float32, shape=[None, 32, 32, 3])
s_y_input = tf.placeholder(tf.float32, shape=[None, 100])
s_model = Model(s_x_input, s_y_input, mode='train')

u_x_input = tf.placeholder(tf.float32, shape=[None, 32, 32, 3])
u_y_input = tf.placeholder(tf.float32, shape=[None, 100])
